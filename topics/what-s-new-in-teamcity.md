...
[Let's Encrypt](https://letsencrypt.org) is a non-profit Certificate Authority (CA) that provides TLS certificates trusted by all modern browsers. Starting with version 2023.05, TeamCity can contact this CA to automatically issue and set up a valid certificate.
