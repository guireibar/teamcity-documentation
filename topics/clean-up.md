...
To change the timeout, set the `teamcity.deletedBuildTypes.cleanupTimeout` [internal property](server-startup-properties.md#TeamCity+Internal+Properties) to the required number of seconds to protect the data from deletion.
{product="tc"}
