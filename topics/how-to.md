...
Here are some recommendations to tweak TeamCity server setup for better performance. The list for [production server use](configure-server-installation.md#Configuring+Server+for+Production+Use) is a prerequisite:
