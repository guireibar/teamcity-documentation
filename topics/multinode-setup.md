...
2. Provide the path to the [shared Data Directory](#Shared+Data+Directory) via the `TEAMCITY_DATA_PATH` [environment variable](server-startup-properties.md#Standard+TeamCity+Startup+Scripts).
